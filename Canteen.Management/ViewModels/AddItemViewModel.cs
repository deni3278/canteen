...
public class AddItemViewModel : ObservableValidator
{
    ...
    {
        AddCommand = new RelayCommand(CreateItem,
                                      () => !HasErrors);
        ...
        ErrorsChanged += (_,
                          _) => AddCommand.NotifyCanExecuteChanged();
    ...
    [Required]
    [CustomValidation(typeof(AddItemViewModel),
                      nameof(ValidatePrice))]
    public string Price
    {
        get => _price;
        set =>
            TrySetProperty(ref _price,
                           value,
                           out _);
    }
    ...
    [Required]
    [CustomValidation(typeof(AddItemViewModel),
                      nameof(ValidateFileName))]
    public string Path
    {
        get => _path;
        set =>
            SetProperty(ref _path,
                        value,
                        true);
    }
                                                 ...
                                                 ValidationContext context)
    {
        return (decimal.TryParse(price,
            ...
            : new ValidationResult("Cannot be parsed to a decimal"))!;
    }
